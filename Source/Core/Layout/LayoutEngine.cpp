...
static void SetYogaMargin(YGNodeRef node, YGEdge edge, Style::LengthPercentageAuto value)
{
	switch (value.type)
	{
	case Style::LengthPercentageAuto::Auto:
		YGNodeStyleSetMarginAuto(node, edge);
		break;
	case Style::LengthPercentageAuto::Length:
		YGNodeStyleSetMargin(node, edge, value.value);
		break;
	case Style::LengthPercentageAuto::Percentage:
...
static void SetYogaPadding(YGNodeRef node, YGEdge edge, Style::LengthPercentage value)
{
	switch (value.type)
	{
	case Style::LengthPercentage::Length:
...
static void ApplyYogaStyleToNode(YGNodeRef node, Element* element)
{
...

	{
		...
		case Style::LengthPercentageAuto::Auto:
			...
			break;
		case Style::LengthPercentageAuto::Length:
			YGNodeStyleSetFlexBasis(node, fb.value);
			break;
		case Style::LengthPercentageAuto::Percentage:
			YGNodeStyleSetFlexBasisPercent(node, fb.value);
			break;
		}
	}
